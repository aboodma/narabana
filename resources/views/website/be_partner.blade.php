        ...
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route('provider_request') }}" id="be_our_partner" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="name" required type="text" class="form-control rd-in @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="email" required type="email" class="form-control rd-in @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="password" required type="password" class="form-control rd-in @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select required name="provider_type_id" class="form-control" id="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="file" required name="video" class="form-control rd-in" accept="video/*" id="">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="file" required name="avatar" class="form-control rd-in" accept="image/*" id="">
            </div>
        </div>
        <div class="form-group row ">
