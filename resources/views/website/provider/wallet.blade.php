        ...
        <div class="row">
            ...
            <div class="col-lg-8 right">
                <div class="p-4 bg-white rounded shadow-sm my-3">
                    <h6 class="mb-2 font-weight-bold">My Wallet
                    </h6>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="@if($wallet->transaction_type == 0) text-success @else text-danger @endif"> @if($wallet->transaction_type == 0) Income @else Payout @endif </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td class="border-right-0"><b>Total Wallet Balance</b></td>
