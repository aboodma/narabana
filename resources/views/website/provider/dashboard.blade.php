            ...
            <div class="col-lg-3 left">
                <div class="mb-3 border rounded list-sidebar overflow-hidden bg-white">
                    ...
                    <ul class="list-group list-group-flush">
                        <li>
                            <a class="p-3 d-inline-block w-100 border-bottom text-muted active-menu" href="#Alerts"> <i class="fa fa-dashboard"></i> Dashboard</a>
                          </li>
                      <li>
                        <a class="p-3 d-inline-block w-100 border-bottom text-muted " href="#Alerts"> <i class="fa fa-address-card-o"></i> My Profile</a>
                      </li>
                      <li>
                        <a class="p-3 d-inline-block w-100 border-bottom text-muted" href="#Badges"> <i class="fa fa-gears"></i> My Services</a>
                      </li>
                      <li>
